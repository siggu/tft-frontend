...
import { getSet12TraitBackgroundImageUrl } from '../../traitColors/set12/Set12TraitColors';
...
const Set12Synergy = ({ trait, synergy }: SynergyProps) => {
  const backgroundImageUrl = getSet12TraitBackgroundImageUrl(trait.name, trait.num_units);
