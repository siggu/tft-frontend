...
import {Box, Container, HStack, Image, Text, Tooltip, VStack, Grid, Wrap, WrapItem} from '@chakra-ui/react';
...
export default function ChampionDetail() {
  ...
  // test
  allChampionsData?.map((item) => {
    item.origin.map((origin_obj) => {
      if (origin_obj.name === '이야기꾼') {
  ...
  return (
    <Grid maxW="1120px" mt="20px" p="20px" minW="700px" overflow={'auto'}>
      <Grid maxW="1120px" w={'100%'} gap={'5px'} templateColumns="repeat(10,1fr)" pl="10%" pr="10%">
